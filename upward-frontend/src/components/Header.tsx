  ...
  return (
    <header className="backdrop-blur-md bg-black text-white flex justify-between items-center px-6 py-4 shadow-lg border-b border-gray-800">
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <h4 className="text-2xl font-bold text-blue-500 tracking-wide">
          UPWARD
        </h4>
      </div>
      ...
      <nav className="hidden md:flex items-center gap-8">
        <p className="text-lg font-medium hover:text-blue-400 cursor-pointer transition duration-300">
          Explore
        </p>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-16 left-0 w-full bg-gray-900 text-white flex flex-col items-center gap-6 py-6 border-t border-gray-800 md:hidden z-50">
          <p className="text-lg font-medium hover:text-blue-400 cursor-pointer transition">Explore</p>
          <p className="text-lg font-medium hover:text-blue-400 cursor-pointer transition">Watchlist</p>
          <p className="text-lg font-medium hover:text-blue-400 cursor-pointer transition">Your Portfolio</p>
          <p className="text-lg font-medium hover:text-blue-400 cursor-pointer transition">More</p>
          <button className="px-5 py-2 border border-blue-500 text-blue-400 rounded-xl hover:bg-blue-500 hover:text-white transition-all duration-300 shadow-md hover:shadow-blue-500/40">
            Login / Register
          </button>
        </div>
