...
const About = () => {
  return (
    <div className="about text-white flex flex-col items-center px-9 pb-12 min-h-[70vh]">
      ...
      <div className="relative flex flex-col gap-12 max-w-7xl w-full">
        <CurvedLine /> {/* Place the line here, before your feature sections */}
        <CurvedLineOutline />
        {/* Feature 1 */}
        <div className="p-8 bg-gray-900 rounded-2xl border-gray border-2 shadow-md w-1/2 flex flex-col gap-5 z-10">
        ...
        {/* Feature 2 */}
        <div className="p-8 bg-gray-900 border-gray border-2 rounded-2xl shadow-md w-1/2 ml-[50%] flex flex-col gap-5 z-10">
