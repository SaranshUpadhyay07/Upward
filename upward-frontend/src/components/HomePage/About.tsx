  ...
  return (
    <div className="about text-white flex flex-col items-center  px-9 pb-12 min-h-[70vh]">
      ...
      <div className="flex flex-col gap-12 max-w-7xl w-full">
        {/* Feature 1 */}
        <div className="p-8 bg-gray-900 rounded-2xl border-gray border shadow-md w-1/2 flex flex-col gap-5">
        ...
        {/* Feature 2 */}
        <div className="p-8 bg-gray-900 border-gray border rounded-2xl shadow-md w-1/2 ml-[50%] flex flex-col gap-5">
